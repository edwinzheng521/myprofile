...
public class BookmarksController {
    ...
    // Inject UserService and PostService instances.    
    ...
    public ModelAndView webpage() {
        ...
        try {
            // Following line populates bookmark data from the database.
            posts = postService.getBookmarkedPosts(userService.getLoggedInUser().getUserId());
