...
public class Utility {
    ...
    public static List<FollowableUser> createSampleFollowableUserList() {
        ...
        followableUsers.add(new FollowableUser("1", "Kat", "Ragle",
                true, "Mar 07, 2024, 10:54 PM"));
        followableUsers.add(new FollowableUser("2", "Edwin", "Zheng",
                false, "Mar 05, 2024, 11:00 AM"));
        followableUsers.add(new FollowableUser("3", "Aysha", "Amreen",
                true, "Mar 06, 2024, 09:30 AM"));
        followableUsers.add(new FollowableUser("4", "Fourth", "Four",
